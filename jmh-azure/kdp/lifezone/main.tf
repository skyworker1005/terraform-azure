...
module "kdp_adls_gen2" {
  ...
  dbfs_storage_account_name = "${lower(var.dbfs_storage_account_name)}${lower(random_string.unique.result)}"
}
...
module "kdp_databricks_workspace" {
  ...
  sku                      = "premium"
  dbfs_storage_account_name = module.kdp_adls_gen2.dbfs_storage_account_name
}
...
module "kdp_adfs" {
  ...
  location = var.location
  environment = var.environment
  adls_gen2_account_name  = module.kdp_adls_gen2.storage_account_name
  rg_name = "ADF"
